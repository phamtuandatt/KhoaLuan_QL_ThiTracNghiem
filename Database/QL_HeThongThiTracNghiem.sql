...
BEGIN
	...
	WHERE SINHVIEN.MASV = CT_HOCPHAN.MASV
		AND MAHOCPHAN = @MAHOCPHAN
		AND SINHVIEN.MASV NOT IN (SELECT MASV FROM CT_CATHI, CATHI 
									WHERE CT_CATHI.MACATHI = CATHI.MACATHI 
									AND MAHOCPHAN = @MAHOCPHAN)
									
END
GO
EXEC GETDSSVHOCPHANCHUATHI '0101000004'
...
SELECT *FROM HOCPHAN
		...
		SELECT DISTINCT(MASV) FROM CT_CATHI, CATHI 
									WHERE CT_CATHI.MACATHI = CATHI.MACATHI 
									AND MAHOCPHAN = '0101000005'
