...
SELECT *FROM HOCPHAN WHERE MAHOCPHAN = '0101000004'
SELECT *FROM CT_HOCPHAN
SELECT DISTINCT(MALOPHOCPHAN), MAHOCPHAN, MAGV, THU, TIET, PHONG, NGAYBD, NGAYKT FROM CT_HOCPHAN WHERE MAHOCPHAN = '0101000004'

select MAX(MAHOCPHAN) as MAHP from HOCPHAN
select *from HOCPHAN
SET DATEFORMAT DMY INSERT INTO CT_HOCPHAN 
VALUES ((SELECT DBO.AUTO_MALOPHOCPHAN('0101000004')), '2001190001', '0101000004', '01001001', 2, '1-3', N'A102', '15/11/2022', '15/02/2023')

SELECT DBO.AUTO_MALOPHOCPHAN('0101000009') AS MALHP
