...
SELECT *FROM DETHI
SELECT TINHTRANG FROM CATHI WHERE MACATHI = 3
EXEC GET_DS_CATHIS

SELECT COUNT(MAHOCPHAN) MAHP FROM CATHI WHERE NGAYTHI = '2022-12-02' AND GIOLAMBAI = N'Tiết 3' AND PHONGTHI = 'A103'
UPDATE CATHI SET TINHTRANG = 1 WHERE MACATHI = 1