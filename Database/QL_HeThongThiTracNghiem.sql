...
(
	...
	CONSTRAINT FK_CT_HOCPHAN_HOCPHAN FOREIGN KEY (MAHOCPHAN) REFERENCES HOCPHAN(MAHOCPHAN) ON DELETE CASCADE,
)
...
(
	...
	CONSTRAINT FK_CT_GIANGDAY_HOCPHAN FOREIGN KEY (MAHOCPHAN) REFERENCES HOCPHAN(MAHOCPHAN) ON DELETE CASCADE,
	CONSTRAINT FK_CT_GIANGDAY_GIANGVIEN FOREIGN KEY (MAGV) REFERENCES GIANGVIEN(MAGV) ON DELETE CASCADE,
)
...
(
	...
	CONSTRAINT FK_NGANHANGCAUHOI_NGANHANGCAUHOI FOREIGN KEY (MANGANHANG) REFERENCES NGANHANGCAUHOI(MANGANHANG) ON DELETE CASCADE,
	CONSTRAINT FK_NGANHANGCAUHOI_GIANGVIEN FOREIGN KEY (MAGV) REFERENCES GIANGVIEN(MAGV) ON DELETE CASCADE,
	CONSTRAINT FK_NGANHANGCAUHOI_HOCPHAN FOREIGN KEY (MAHOCPHAN) REFERENCES HOCPHAN(MAHOCPHAN) ON DELETE CASCADE,
)
...
(
	...
	CONSTRAINT FK_CAUHOI_NGANHANGCAUHOI FOREIGN KEY (MANGANHANG) REFERENCES NGANHANGCAUHOI(MANGANHANG) ON DELETE CASCADE,
	CONSTRAINT FK_CAUHOI_MAHOCPHAN FOREIGN KEY (MAHOCPHAN) REFERENCES HOCPHAN(MAHOCPHAN) ON DELETE CASCADE,
)
...
(
	...
	CONSTRAINT FK_CT_DETHI_CAUHOI FOREIGN KEY (MACAUHOI) REFERENCES CAUHOI(MACAUHOI) ON DELETE CASCADE,
)
...
(
	...
	CONSTRAINT FK_NGANHANGCAUHOI_DADUYET_HOCPHAN FOREIGN KEY (MAHOCPHAN) REFERENCES HOCPHAN(MAHOCPHAN) ON DELETE CASCADE,
	CONSTRAINT FK_NGANHANGCAUHOI_DADUYET_CAUHOI FOREIGN KEY (MACAUHOI) REFERENCES CAUHOI(MACAUHOI) ON DELETE CASCADE,
)
...
(
	...
	CONSTRAINT FK_CATHI_HOCPHAN FOREIGN KEY (MAHOCPHAN) REFERENCES HOCPHAN(MAHOCPHAN) ON DELETE CASCADE,
	CONSTRAINT FK_CATHI_DETHI FOREIGN KEY (MADETHI) REFERENCES DETHI(MADETHI) ON DELETE CASCADE,
)
...
(
	...
	CONSTRAINT FK_CT_CATHI_SINHVIEN FOREIGN KEY (MASV) REFERENCES SINHVIEN(MASV) ON DELETE CASCADE,
)

SELECT *FROM CATHI
SELECT *FROM CT_CATHI
DELETE FROM CATHI WHERE MACATHI = 1
...
END
GO
EXEC GET_DS_SV_LOPHOCPHAN '0101000005'
...
END
GO
EXEC GET_CT_LOPHOCPHAN '010100001104'
...
BEGIN
	...
	WHERE SINHVIEN.MASV = CT_HOCPHAN.MASV
		...
		AND SINHVIEN.MASV NOT IN (SELECT DISTINCT(MASV) FROM CT_CATHI, CATHI 
									...
									AND MAHOCPHAN = '0101000005' AND TINHTRANGTHI = 0)
END
GO
EXEC GETDSSVHOCPHANCHUATHI '0101000005'

SELECT *FROM CATHI
SELECT *FROM CT_CATHI
EXEC GETDSCATHI
EXEC GETDSSVTHAMGIA 3
SELECT *FROM CT_HOCPHAN
SELECT *FROM HOCPHAN
...
END
GO
EXEC GETDSCATHINGAY '2022-12-08'
EXEC GETDSCATHINGAY '08-Dec-22 1:07:15 PM'
...
END
GO
EXEC GETDSCATHI_PHONG_TIET_NGAY N'A102', N'Tiết 3', '2022-12-08'
...
END
GO
EXEC GETDSCATHI_PHONG_TIET N'A102', N'Tiết 3'
...
SELECT *FROM HOCPHAN WHERE MAHOCPHAN = '0101000019'
SELECT *FROM CT_HOCPHAN WHERE MAHOCPHAN = '0101000019'