...
(
	...
	CONSTRAINT PK_DETHI PRIMARY KEY (MADETHI, MAHOCPHAN, NGAYTAO),
...
(
	...
	CONSTRAINT FK_CT_DETHI_DETHI FOREIGN KEY (MADETHI, MAHOCPHAN, NGAYTAO) REFERENCES DETHI(MADETHI, MAHOCPHAN, NGAYTAO),
...
(
	...
	CONSTRAINT FK_CATHI_DETHI FOREIGN KEY (MADETHI, MAHOCPHAN, NGAYTAO) REFERENCES DETHI(MADETHI, MAHOCPHAN, NGAYTAO),
)
...
(
	...
	CONSTRAINT PK_CT_BAITHI PRIMARY KEY (MABAITHI),
...
END
GO
EXEC GET_DS_CAUHOI_NGANHANG 1, '0101000001'
...
AS
BEGIN
	SELECT MADETHI, DETHI.MAHOCPHAN, TENHOCPHAN, NGAYTAO, GIOBATDAU, NGAYTHI, TGLAMBAI, SLCAUHOI, TINHTRANG
	FROM DETHI, HOCPHAN
	WHERE DETHI.MAHOCPHAN = HOCPHAN.MAHOCPHAN
		AND DETHI.MAHOCPHAN = @MAHOCPHAN
END
GO
EXEC GET_DS_DETHI '0101000001'
...
GO
CREATE PROC GET_DS_DETHI_CAUHOI @MADETHI CHAR(10), @MAHOCPHAN CHAR(10)
AS
BEGIN
...
WHERE CT_DETHI.MACAUHOI = CAUHOI.MACAUHOI
	AND MADETHI = @MADETHI AND CT_DETHI.MAHOCPHAN = @MAHOCPHAN
END
GO
EXEC GET_DS_DETHI_CAUHOI '02', '0101000001'
