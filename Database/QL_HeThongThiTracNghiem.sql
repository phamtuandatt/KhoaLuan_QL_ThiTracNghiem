...
(
	...
	CONSTRAINT PK_DETHI PRIMARY KEY (MADETHI, MAHOCPHAN),
...
(
	...
	CONSTRAINT FK_CT_DETHI_DETHI FOREIGN KEY (MADETHI, MAHOCPHAN) REFERENCES DETHI(MADETHI, MAHOCPHAN),
...
(
	...
	CONSTRAINT FK_CATHI_DETHI FOREIGN KEY (MADETHI, MAHOCPHAN) REFERENCES DETHI(MADETHI, MAHOCPHAN),
)
...
END
GO
EXEC GET_DS_DETHI_CAUHOI '01', '0101000001'
...
AS
BEGIN
	SELECT MACATHI, CATHI.MAHOCPHAN, TENHOCPHAN, MADETHI, NGAYTHI, GIOLAMBAI, TINHTRANG
	FROM CATHI, HOCPHAN
