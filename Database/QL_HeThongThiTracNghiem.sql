...
BEGIN
	...
	WHERE CT_HOCPHAN.MASV = SINHVIEN.MASV
		AND MAHOCPHAN = @MAHOCPHAN AND CT_HOCPHAN.MASV IN (SELECT DISTINCT(MASV) FROM CATHI, CT_CATHI 
...
SELECT *FROM CATHI
select *from BAITHI
SELECT *FROM HOCPHAN WHERE MAHOCPHAN IN (SELECT MAHOCPHAN FROM DETHI)
