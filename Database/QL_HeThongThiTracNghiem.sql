...
EXEC GET_DS_CAUHOI_NGANHANG 1, '0101000001'
	...
	SELECT MACAUHOI FROM CAUHOI WHERE MANGANHANG = 1 AND MAHOCPHAN = '0101000005' 
	SELECT *FROM NGANHANGCAUHOI_DADUYET WHERE MAHOCPHAN = '0101000005'

	DELETE FROM NGANHANGCAUHOI_DADUYET WHERE MAHOCPHAN = '0101000005'
...
AS
BEGIN
	SELECT MACATHI, CATHI.MAHOCPHAN, TENHOCPHAN, MADETHI, MADECON, NGAYTHI, GIOLAMBAI, TINHTRANG
	FROM CATHI, HOCPHAN
...
AS
BEGIN
	SELECT SINHVIEN.MASV, TENSV, GIOITINH, NGAYSINH, MALOP
	FROM SINHVIEN, CT_CATHI
	WHERE SINHVIEN.MASV = CT_CATHI.MASV
		AND MACATHI = @MACATHI
END
GO
EXEC GET_DSSV_CATHI 1
...
select *from CT_HOCPHAN
SET DATEFORMAT DMY INSERT INTO CT_HOCPHAN 
VALUES ((SELECT DBO.AUTO_MALOPHOCPHAN('0101000004')), '2001190006', '0101000004', '01001001', 2, '1-3', N'A101', '15/11/2022', '15/02/2023')

SELECT *FROM GIANGVIEN

SELECT *FROM NGANHANGCAUHOI

SELECT COUNT(MAGV) FROM GIANGVIEN WHERE MAGV = '01001002' AND MATKHAU = '000000000'
