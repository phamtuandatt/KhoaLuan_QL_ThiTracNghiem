...
SELECT *FROM LOPHOC
		...
		SELECT MASV FROM SINHVIEN, LOPHOC WHERE SINHVIEN.MALOP = LOPHOC.MALOP AND MAKHOA = '01'
		AND  MASV NOT IN (SELECT MASV FROM CT_HOCPHAN WHERE MALOPHOCPHAN = '010100000401')
		
		(SELECT MASV FROM CT_HOCPHAN WHERE MALOPHOCPHAN = '010100000401')